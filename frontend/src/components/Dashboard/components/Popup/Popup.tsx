...
const Popup = (props: {
  ...
  const handleEditSubmit = async (
    ...
    const updatedMemo = {
      ...
      media: props.selectedMemo.media,
    };
  ...
  return (
    <div className="popup bg-sky-200" onClick={props.onClick}>
      ...
      {editing ? (
        ...
        <>
          ...
          <button
            ...
            className="text-sky-50 w-1/6 bg-sky-500 hover:bg-sky-600 rounded-xl mt-4"
          >
            Edit
          </button>
        </>
      ...
      <button
        ...
        className="text-sky-50 w-1/6 bg-sky-500 hover:bg-sky-600 rounded-xl"
      >
        Close
      </button>
    </div>
